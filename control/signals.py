...
from control.context import get_audit_context
...
AUDITED_MODEL_LABELS = {
    'control.Tenant',
    'control.Package',
    'control.PackageFeature',
    'control.Feature',
    'control.TenantSubscription',
    'control.TenantFeatureOverride',
    'control.PlatformUser',
    'control.PlatformRole',
}
