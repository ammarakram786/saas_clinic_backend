...
from control.models import PlatformPermission, PlatformRole
...
PERMISSIONS = [
    ...
    ('platform.platform_permission.read',   'Read Platform Permissions',   'platform_user', 'View platform permissions.'),
    ('platform.platform_permission.manage', 'Manage Platform Permissions', 'platform_user', 'Create/edit custom platform permissions.'),
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Keep custom permissions that were created dynamically by operators.
